...
<section class="tm-bg-white-transparent tm-app-feature-box" id="section_2">
      ...
      <div class="row">
        ...
        <form action="detail_penjualan_m.php" method="post">
                 ...
                 <input type="submit" value="Tambah Barang" class="custom-btn btn  btn btn-success mt-2">
        </form>
  ...
  <table class="table  border-success table-black table-striped ">
...
?>
        ...
        <select name="id_barang" id="" onchange="this.form.submit()"  style="width: 200px; height: 50px;">
        <?php
          foreach ($dataBarang as $barang) {
      ...
      <th class="col-lg-1   form-check-group">
            <input type="number" class="form-control" style="color:black;" name="jumlah_barang" value="<?= $detail['jumlah_barang'] ?>" tabindex="1" onchange="this.form.submit()">
      </th>
      ...
      <div class="input-group">
        <span class="input-group-text" id="basic-addon1">Rp.</span>
          ...
          <input type="text" class="form-control" style="color:black;"  aria-label="Username" aria-describedby="basic-addon1" name="harga_barang" id="" value="<?= $harga_barang ?>" readonly>
      </div>
       </th>
      ...
      <div class="input-group">
        <span class="input-group-text" id="basic-addon1">Rp.</span>
          <input type="text" class="form-control" style="color:black;" aria-label="Username" aria-describedby="basic-addon1" name="sub_total" id="" value="<?= $detail['sub_total'] ?>" readonly>
      </div>
      </th>
              
      <th class="col-lg-1   form-check-group">
        <input type="text" class="form-control" style="color:black;" name="stok_barang" value="<?= $stok_barang ?>" readonly>
      </th>
        ...
        <form action="m_hitung_total.php" method="post">
          ...
          <tr>
            ...
            <div class="input-group" >
              ...
              <span class="input-group-text" id="basic-addon1">Rp.</span>
              <input type="text" class="form-control"  aria-label="Username" aria-describedby="basic-addon1" style="color:black;" name="total" id="" value="<?= $total['Total'] ?>" readonly>
            </div>
            </div>
            </th>
            <th ></th>
          ...
          <tr>
            ...
            <label for="" class=" col-lg-2 col-form-label m-2">Bayar</label>
              <span class="input-group-text" id="basic-addon1">Rp.</span>
              <input type="number" name="bayar" id="bayar" onchange="this.form.submit()" tabindex="1" class="form-control" style="color:black;" aria-label="Username" aria-describedby="basic-addon1">
            </div>
            </div>
            </th>
            ...
            <label for="" class="col-lg-2 col-form-label m-2">Kembali</label>
              <span class="input-group-text" id="basic-addon1">Rp.</span>
                <input type="number" name="kembali" id="" value="<?php if (isset($_GET['kembali'])) {  echo    $kembali = $_GET['kembali'];
                  } ?>" class="form-control"  aria-label="Username" aria-describedby="basic-addon1" style="color:black;" name="total" id=""  readonly>
            </div>
            </div>
            </th>
