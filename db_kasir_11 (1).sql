...
(1, 'millo bubuk', 675, 3000.00),
(2, 'buku', 687, 5000.00),
(3, 'susu', 777, 4500.00),
(4, 'the pucuk', 767, 3000.00),
(5, 'pulpen', 577, 2000.00),
(7, 'pensil', 567, 1500.00),
(8, 'sendal', 467, 18000.00),
(9, 'rokok surya', 567, 25000.00),
(10, 'rokok sampurna mill', 567, 33000.00);
...
(1, 'ADIB IRFANI', 'adib', '12345', 'Administrator'),
(2, 'lukmanharis', 'lukman', '123456', 'Petugas'),
(3, 'sobirin', 'birin', '123456', 'Petugas');
...
(30527, 'pak ari', 'blega', '0987654765');
